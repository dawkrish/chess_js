...
export class Board{
    ...
    create_board(){
        ...
        this.arr[0][1].piece = new Knight(this,"black",this.arr[0][1].coordinates)
        this.arr[0][2].piece = new Bishop(this,"black",this.arr[0][2].coordinates)
        ...
        this.arr[0][5].piece = new Bishop(this,"black",this.arr[0][5].coordinates)
        this.arr[0][6].piece = new Knight(this,"black",this.arr[0][6].coordinates)
        ...
        this.arr[7][1].piece = new Knight(this,"white",this.arr[7][1].coordinates)
        this.arr[7][2].piece = new Bishop(this,"white",this.arr[7][2].coordinates)
        ...
        this.arr[7][5].piece = new Bishop(this,"white",this.arr[7][5].coordinates)
        this.arr[7][6].piece = new Knight(this,"white",this.arr[7][6].coordinates)
...
function foo(a){
    ...
    if(ui_square_clicked.getAttribute("clicked") == "false" && game_square_clicked.piece != null && ui_square_clicked.getAttribute("highlighted") == "false"){
        ...
        console.log('setting ui click to true')
        ...
        for(let i = 0; i < valid_moves.length; i++){
            ...
            squares[valid_moves[i][0]][valid_moves[i][1]].setAttribute('highlighted',"true")
        }
    }
